...
3. **AI memory & working rules**:
   ...
   - [current_focus.md](file:///home/nick/ai-fsm-deploy-clean/ai/current_focus.md)
...
- **Update the Memory**: If your task results in an architectural change or a new locked decision, update `ai/decisions.md` or `ai/current_focus.md` accordingly.
