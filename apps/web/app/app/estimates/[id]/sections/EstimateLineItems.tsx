...
/**
 * Renders the estimate's pricing breakdown in one of three layouts:
 * multi-option comparison, mobile card list, or the desktop line-item table.
 */
export function EstimateLineItems({ estimate, lineItems, options, isMobileWorkspace }: Props) {
