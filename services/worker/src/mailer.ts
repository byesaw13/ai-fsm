...
export function clientReactivationHtml(d: {
  clientName: string; monthsSinceLastService: number;
}): string {
  return wrap(`
...
export function seasonalReminderHtml(d: {
  clientName: string; season: "spring" | "fall";
}): string {
...
export function recurringInspectionHtml(d: {
  clientName: string; planName: string; propertyAddress: string | null;
}): string {
  return wrap(`
