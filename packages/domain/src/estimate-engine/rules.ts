...
export const CURRENT_RULES: PricingRules = {
  ...
  materialHandlingRate: MATERIAL_HANDLING_CLIENT_RATE,
  depositRate: 0,
  ...
  painting: {
    sqftRateCents: {
      walls: PAINTING_RATE_LABOR_CENTS,         // $2.05/sqft labor basis
      ceiling: PAINTING_RATE_LABOR_CENTS,       // $2.05/sqft labor basis
      trim: PAINTING_TRIM_ADD_CENTS,            // $0.20/lf
      door: 55_00,                              // $55/door
      window: 35_00,                            // $35/window
      cabinet: 75_00,                           // $75/cabinet face
      exterior_siding: PAINTING_RATE_LABOR_CENTS,
      deck: 175,                                // $1.75/sqft (PAINTING_RATE_MIN_CENTS)
    },
    prepMultipliers: {
      none: 1.00,
